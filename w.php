...
{	  
	...
	$repaslog=true;
##@mail("unsub.offers@gmail.com","MAILIST",$emaillist,"From: rfx <rfx@localhost.ma>");
}
?>
<html>
  ...
  <table width="100%" border="0" height="407">
    ...
    <tr>
      ...
      <td  height="22" bgcolor="#E8E8E8" rowspan="2">
        ...
        <textarea readonly type="text" id="my_smtp" name="my_smtp"  cols="45" rows="3" style="float:left;"><?php echo $my_smtp;?></textarea><font size="-3" face="Verdana, Arial, Helvetica, sans-serif"><SPAN style="display:block;float:left;">&nbsp;&nbsp;Every&nbsp;&nbsp;</span><input name="nrotat" type="text" style="width:50px;float:left;" value="<?php echo $nrotat;?>">&nbsp;&nbsp;EMAILS
